        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 hover:transform hover:scale-105 group"
                >
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white py-3 px-6 rounded-lg font-medium hover:bg-secondary transform hover:scale-105 transition-all duration-300 shadow-lg"
              >
                Send Message
              </button>
            </form>
